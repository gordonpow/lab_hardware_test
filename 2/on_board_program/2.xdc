...
#Switch
#SW1
set_property -dict {PACKAGE_PIN F22 IOSTANDARD LVCMOS25} [get_ports {i_up_down}]
...
set_property -dict {PACKAGE_PIN H19 IOSTANDARD LVCMOS25} [get_ports {i_limit_upper[1]}]
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS25} [get_ports {i_limit_upper[0]}]
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS25} [get_ports {i_limit_lower[1]}]
set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS25} [get_ports {i_limit_lower[0]}]
